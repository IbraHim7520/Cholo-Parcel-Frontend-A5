                    ...
                    <div className="flex flex-col md:flex-row md:items-end gap-4 -mt-14">
                        ...
                        <div className="relative mx-auto md:mx-0">
                            <div className="size-28 rounded-2xl border-4 border-white bg-slate-100 overflow-hidden shadow-lg">
                                {user?.image ? (
                                    <Image src={user?.image || "https://img.freepik.com/free-vector/isolated-young-handsome-man-different-poses-white-background-illustration_632498-857.jpg"} alt={user.name} fill className="object-cover" />
                                ) : (
...
export default MerchentSettings;