...
const CustomNotFoundPage = () => {
    return (
        <div className="flex flex-col items-center justify-center text-sm min-h-screen">
            <p className="font-medium text-lg text-orange-500">404 Error</p>
            ...
            <div className="flex items-center gap-4 mt-6">
                <Link href={"/"} type="button" className="bg-orange-500 hover:bg-orange-600 px-7 py-2.5 text-white rounded active:scale-95 transition-all">
                    Go back home
                </Link>
                <Link href={"/contact"} type="button" className="group flex items-center gap-2 px-7 py-2.5 active:scale-95 transition">
                    Contact support
