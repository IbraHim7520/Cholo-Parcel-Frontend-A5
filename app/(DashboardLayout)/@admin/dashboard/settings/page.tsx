            ...
            <div className="max-w-full mx-auto px-6">
                ...
                <aside className="w-full">
                    <div className="w-full">
                        {user && user.role === UserRole.USER && <AdminSettings user={user} />}
                        {user && user.role === UserRole.MERCHENT && <MerchentSettings user={user} />}
                        {user && user.role === UserRole.RIDER && <RidersSetting user={user} />}
